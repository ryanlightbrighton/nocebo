...
if (_currHealth == 0) then {
	...
	private _skillName = "skillTyreFitter";
	...
	private _actionItems = ["tyre",_item] call horde_fnc_spawnActionItems;
	...
	if (isNull _display or {time < _timeOut}) then {
		...
		private _failText = "You fitted the tyre but broke the %2";
		private _repairText = "You fitted the %1";
