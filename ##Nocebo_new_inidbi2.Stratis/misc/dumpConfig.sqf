...
Dump the entire config, it can take over ten seconds:
    ...
    [configFile] call compile preprocessFileLineNumbers "misc\dumpConfig.sqf"

    // MY EDITS

    [configFile >> "CfgExperience", true] call compile preprocessFileLineNumbers "misc\dumpConfig.sqf"
    [configFile >> "CfgVehicles" >> "ncb_player_base", true] call compile preprocessFileLineNumbers "misc\dumpConfig.sqf"
    [configfile >> "CfgActions", true] call compile preprocessFileLineNumbers "misc\dumpConfig.sqf"
    0 = [configfile >> "CfgVehicles" >> "O_Soldier_F" >> "HitPoints", true] call compile preprocessFileLineNumbers "misc\dumpConfig.sqf"
    0 = [configfile >> "CfgVehicles" >> "ncb_heli_orca" >> "SoundsExt" >> "Sounds" >> "RainExt", true] call compile preprocessFileLineNumbers "misc\dumpConfig.sqf"
